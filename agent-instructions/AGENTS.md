...
The site uses Cloudflare. The client has 500ms delays between form submissions, 300ms between downloads, and exponential backoff retry (up to 5 attempts) on 403/429 responses.
